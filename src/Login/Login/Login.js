                ...
                <div className="login-container">
                    ...
                    <form onSubmit={loginFormSubmit}>
                        ...
                        <div className="mb-3 d-flex justify-content-center">
                            <input type="submit" className="bg-primary text-white btn px-5 login-btn" value="Login" />
                        </div>
                    ...
                    <div className="d-flex flex-column align-items-center others-signin">
                        ...
                        <button onClick={handleGoogleSignIn} className="google-signin-btn">
                            <img width="20px" className="img-fluid" src={`https://www.freepnglogos.com/uploads/google-logo-png/google-logo-png-webinar-optimizing-for-success-google-business-webinar-13.png`} alt="" />
                        </button>
                    </div><br/><br/>
                </div>
            </div><br/>
